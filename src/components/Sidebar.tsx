...
export function Sidebar({ onNewSecurity, onNewWatchlist, onNewTaxonomy, onNewTopic }: { onNewSecurity():void;onNewWatchlist():void;onNewTaxonomy():void;onNewTopic():void }) {
  ...
  return <><aside className="sidebar">
    ...
    <div className="sidebar-section"><SectionHeader title="Research" onAdd={onNewTopic}/><Button fill alignText="start" variant="minimal" icon="series-search" className={`nav-item ${app.view.type==='topics'||app.view.type==='topic'?'active':''}`} text="Topics" onClick={()=>app.setView({type:'topics'})}/></div>
